...
export default function About() {
  ...
  return (
    <div className="min-h-screen pt-16 dark:bg-black">
      <div className="container mx-auto px-6 md:px-16 lg:px-24 xl:px-32 dark:bg-black dark:text-white">
        <div className="py-8 md:py-20 flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            ...
            <p className="dark:text-gray-300 text-gray-500 leading-relaxed">
              ...
              backend solutions. I specialize in full-stack development,
              bringing together modern frameworks and best practices to create
              seamless applications.
            </p>

            <p className="dark:text-gray-300 text-gray-500 leading-relaxed">
              With experience in frontend and backend technologies, I love
              solving complex problems, optimizing performance, and continuously
              learning new technologies to stay ahead in the evolving tech
              landscape.
            </p>
